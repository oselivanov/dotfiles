...
" Use control h/l to navigate in command mode (pretty useful in file renaming).
cnoremap <c-h> <left>
cnoremap <c-l> <right>
...
if has("autocmd")
    ...
    autocmd FileType ruby setlocal iskeyword+=\$ iskeyword+=\: ts=2 sts=2 sw=2 et
    ...
    autocmd FileType php setlocal iskeyword+=\$ ts=4 sts=4 sw=4 et
    autocmd FileType lua setlocal ts=2 sts=2 sw=2 et

    autocmd FileType javascript setlocal ts=2 sts=2 sw=2 et
    autocmd FileType coffee setlocal ts=4 sts=4 sw=4 et
    autocmd FileType html setlocal iskeyword+=\> its=2 sts=2 sw=2 et
    ...
    autocmd FileType python,javascript,haskell,c,cpp,php,haxe,vim,apache,html,xhtml,xml,css,ruby,eruby,htmldjango,sh autocmd BufWritePre <buffer> silent :%s/\s\+$//e
endif
